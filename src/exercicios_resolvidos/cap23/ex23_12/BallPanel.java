package exercicios_resolvidos.cap23.ex23_12;

// Exercise 23.12 Solution: BallPanel.java
...
public class BallPanel extends JPanel
{
   ...
   public void paintComponent(Graphics g)
   {
      ...
      for (Ball b : balls)
      {
         ...
         g.fillOval(b.getX(), b.getY(), 10, 10); // draw ball

         g.setColor(Color.DARK_GRAY); // set shadow color
         g.fillOval(b.getX(), MAX_Y - 5, 10, 5); // draw shadow
      } // end for
