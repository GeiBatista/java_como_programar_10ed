package exercicios_resolvidos.cap07.ex7_29.part_c;

// Exercise 7.29 Part C Solution: Series2.java
...
public class Series2
{
   ...
   public static double fibonacci(int nElement)
   {
      double temp = 1; // number to be added
      double fibNumber = 0; // fibonacci number
