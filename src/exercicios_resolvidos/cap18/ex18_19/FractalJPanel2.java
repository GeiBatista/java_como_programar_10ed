...
// Exercise 18.19 Solution: FractalJPanel2.java
// FractalJPanel2 demonstrates recursive drawing of a star fractal.
import java.awt.Graphics;
import java.awt.Color;
import java.awt.Dimension;
import javax.swing.JPanel;

public class FractalJPanel2 extends JPanel 
{
   private Color color;
   private int level;
   ...
   public FractalJPanel2(int currentLevel)
   {
      color = Color.GREEN;
      level = currentLevel;
   ...
   public void paintComponent(Graphics g)
   {
      ...
      // draw star using fractal design           
