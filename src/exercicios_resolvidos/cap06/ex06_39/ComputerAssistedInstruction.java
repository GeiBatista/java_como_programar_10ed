...
// Exercise 6.39 Solution: ComputerAssistedInstruction.java
...
public class ComputerAssistedInstruction
{
   ...
   public ComputerAssistedInstruction(int difficultyLevel, int operation)
   {
      ...
      {
         System.out.println("Operation type level must in the range 1-5");
