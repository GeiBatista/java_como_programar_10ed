package exercicios_resolvidos.cap17.ex17_14;
// Exercise 17.14: IntStreamOperations.java// Demonstrating IntStream operations.
...
public class IntStreamOperations
{
   public static void main(String[] args)
   {
      ...
      System.out.printf("Sum of squares via map then reduce: %d%n", 
         IntStream.of(values)                   
