...
public class ImageWatermarking {
	public static void main(String[] args) {
		...
		try {
			File file = new File("C:/Users/Gei Batista/Desktop/download.jpg");
			if (!file.exists()) {
			...
			String watermark = "Documento Cancelado!";
			...
			g2d.drawString(watermark, (icon.getIconWidth() - (int) rect
					...
					.getHeight()) / 2);
			g2d.dispose();
			File fileout = new File("F:/watermarkedImage.jpg");
