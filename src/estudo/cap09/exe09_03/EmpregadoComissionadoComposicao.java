...
public class EmpregadoComissionadoComposicao {
	...
	public EmpregadoComissionadoComposicao(String nome, String sobrenome, String seguroSocial, double vendaBruta,
			double comissao) {
